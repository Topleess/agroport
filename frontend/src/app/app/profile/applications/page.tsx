...
import { listMyRequests } from "@/lib/api/solutions";
    ...
    <ProfilePageShell>
      <div className="grid gap-6">
        <section>
          ...
          <h1 className="mt-2 text-3xl font-bold tracking-normal md:text-4xl">Заявки</h1>
          <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-500">
            История заявок пользователя и связанных хозяйств на цифровые решения.
          </p>
        </section>
        ...
        {loading ? (
                  ...
                  <div className="flex min-w-0 gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 text-sm leading-6 text-zinc-500">
                        {item.message || "Комментарий не указан."}
                      </p>
          ...
          <div className="rounded-[24px] bg-white p-8 text-center shadow-[0_14px_40px_rgba(15,23,42,0.07)]">
            ...
            <p className="mt-2 text-sm text-zinc-500">Откройте каталог решений и оставьте первую заявку.</p>
